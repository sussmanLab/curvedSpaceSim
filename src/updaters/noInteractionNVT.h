#ifndef noInteractionNVT_H
#define noInteractionNVT_H

#include "baseUpdater.h"

/*! \file noseHooverNVT.h */
//! Implements ideal gas NVT dynamics according to the Nose-Hoover equations of motion with a chain of thermostats
/*!
 This allows one to do just ideal gas NVT simulations.  A chain (whose length can be
