...
*/
simpleModelDatabase::simpleModelDatabase(
    int numberOfParticles, string fn, fileMode::Enum _mode, bool saveVelocities, bool saveTypes, bool saveForces
)
...
unsigned long simpleModelDatabase::currentNumberOfRecords() { return getDatasetDimensions("time"); }
