...
/*!
Uses the "offset" to correctly identify "all particles other than some given index". For standard models there is no offset, but for MPI
models the offset is important. The return value of this function is VERYLARGEDOUBLE, which should never be used for anything.
 */
double baseNeighborStructure::constructCandidateNeighborList(
