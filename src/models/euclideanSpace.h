...
/*!
The simplest version of a space, distances are just computed as the difference between points in R^3, and particle displacements are trivial
vector addition. A useful space for debugging, e.g., the force and equation of motion parts of the code base
*/
